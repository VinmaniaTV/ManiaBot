...
const osu_1 = require("./osu");
const mysql_1 = require("mysql");
let MessageResponder = class MessageResponder {
    constructor(league, osu, prefix, calendar, mysqlHost, mysqlPort, mysqlUser, mysqlPassword, mysqlDatabase) {
        this.league = league;
        this.osu = osu;
        this.prefix = prefix;
    ...
    handle(message, music) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Calendar Commands.
                ...
                let req = https_1.get(this.calendar, function (res) {
                    let data = '', calendar, calendar_week = [];
            ...
            // League Commands
                ...
                if ((yield this.league.updateSummonerData(summonerName)) == false) {
                            ...
                            this.con.query('SELECT * FROM summoners s INNER JOIN league l ON s.id = l.summonerId WHERE s.name = "' + summonerName + '";', function (error, results, fields) {
                                ...
                                if (results[0] != null) {
                                    ...
                                    this.con.query('SELECT * FROM summoners WHERE name = "' + summonerName + '";', function (error, results, fields) {
                                        if (error)
                                            throw error;
                                        const embedNoInfo = new discord_js_1.MessageEmbed();
            ...
            // Osu Commands
                ...
                let osuData = yield this.osu.getOsuUser(osuUsername);
                console.log(osuData);
                const embed = new discord_js_1.MessageEmbed()
...
MessageResponder = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.TYPES.League)),
    __param(1, inversify_1.inject(types_1.TYPES.Osu)),
    __param(2, inversify_1.inject(types_1.TYPES.Prefix)),
    __param(3, inversify_1.inject(types_1.TYPES.Calendar)),
    __param(4, inversify_1.inject(types_1.TYPES.MysqlHost)),
    __param(5, inversify_1.inject(types_1.TYPES.MysqlPort)),
    __param(6, inversify_1.inject(types_1.TYPES.MysqlUser)),
    __param(7, inversify_1.inject(types_1.TYPES.MysqlPassword)),
    __param(8, inversify_1.inject(types_1.TYPES.MysqlDatabase)),
    __metadata("design:paramtypes", [league_1.League,
        osu_1.Osu, String, String, String, Number, String, String, String])
], MessageResponder);
